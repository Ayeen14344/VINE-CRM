  ...
  "00000000-0000-4000-8000-000000000102": [
    {
      ...
      fields: [
        ...
        {
          key: "day_1_training_schedule",
          label: "Day 1 Training Schedule",
          aliases: ["Training Schedule", "Scheduled Training"],
        },
        { key: "day_2_training_schedule", label: "Day 2 Training Schedule" },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "book_for_training", label: "Book For Training" },
        {
          ...
          aliases: ["Training Schedule", "Day 1 Training Schedule"],
        },
        { key: "day_2_training_schedule", label: "Day 2 Training Schedule" },
      ],
    },
